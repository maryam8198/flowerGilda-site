            ...
            <div class="content-2">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">ویرایش مشخصات مدیر</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form  action="admin_chngeInfo.php" method="post">
                        <div class="card-body ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" name="password" value=<?php echo $username['password']; ?>>
                            </div>
                        </div>
                        <!-- /.card-body -->
...
if (isset($_POST['chngeInfo'])) {
    $username2 = $_SESSION['admin_login'];
    $email = $_POST['email'];
    $fullname = $_POST['fullname'];
    $phone = $_POST['phone'];
    $password = $_POST['password'];

    $Check = mysqli_query($db, "SELECT * FROM admin WHERE name1 ='$username2'");
    if (mysqli_num_rows($Check) > 0) {
        echo '<script>  alert("نام انتخاب شده تکراری است نام دیگری انتخاب کنید")</script>';
    } else {
