...
<section class="plant_section layout_padding">
    <div class="container">
        ...
        <div class="row">
            ...
            $query=mysqli_query($db,"SELECT * FROM favariteflower WHERE user_name='$name'");
         ...
         c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                                ...
                                <a href="config/delete_from_favarite.php?id=<?php echo $row['product_id']?>">
                                    <img src="images/trashbin.png" width="20px" height="20px"/>
                                </a>
